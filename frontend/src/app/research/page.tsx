...
export default function ResearchPage() {
  return (
    <Suspense fallback={<div className={styles.page}><div className={styles.main}>Loading…</div></div>}>
      <ResearchInner />
    </Suspense>
  );
}

/** ✅ Hook lives under Suspense boundary */
function ResearchInner() {
  ...
  // ---- everything below stays EXACTLY your existing code ----
