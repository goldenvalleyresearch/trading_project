...
function groupForKind(kind: string): GroupKey {
  ...
  if (["premarket","am","morning","setup","afterhours","pm","wrap","close","postclose"].includes(k)) return "setup_wrap";
          ...
          {filtered.map((p) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(to top, rgba(7,10,16,.75), rgba(7,10,16,.10)), url(${meta.cover})`,
